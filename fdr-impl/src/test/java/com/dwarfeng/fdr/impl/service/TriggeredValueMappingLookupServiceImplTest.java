...
import com.dwarfeng.fdr.stack.service.TriggeredValueMappingLookupService;
...
public class TriggeredValueMappingLookupServiceImplTest {
    ...
    @Autowired
    private TriggeredValueMappingLookupService triggeredValueMappingLookupService;
    ...
    public void testMappingLookup() throws Exception {
        try {
            ...
            // Groovy映射器测试。
            List<TimedValue> timedValues = triggeredValueMappingLookupService.mappingLookup(new MappingLookupInfo(
            ...
            // 最小值映射器测试。
            timedValues = triggeredValueMappingLookupService.mappingLookup(new MappingLookupInfo(
