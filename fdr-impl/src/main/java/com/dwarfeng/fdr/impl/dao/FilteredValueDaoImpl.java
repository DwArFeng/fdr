...
public class FilteredValueDaoImpl implements FilteredValueDao {
    ...
    @Autowired
    private PresetLookupDao<FilteredValue> presetLookupDao;
    @Autowired
    ...
    public FilteredValue previous(LongIdKey pointKey, Date date) throws DaoException {
        return presetLookupDao.lookupFirst(
                FilteredValueMaintainService.CHILD_FOR_POINT_PREVIOUS, new Object[]{pointKey, date}
        );
    }
    ...
    public FilteredValue rear(LongIdKey pointKey, Date date) throws DaoException {
        return presetLookupDao.lookupFirst(
                FilteredValueMaintainService.CHILD_FOR_POINT_REAR, new Object[]{pointKey, date}
        );
    }
}
