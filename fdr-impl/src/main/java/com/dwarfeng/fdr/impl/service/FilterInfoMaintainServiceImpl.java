...
public class FilterInfoMaintainServiceImpl implements FilterInfoMaintainService {
    ...
    private final BatchCrudService<LongIdKey, FilterInfo> crudService;
    private final EntireLookupService<FilterInfo> entireLookupService;
    private final PresetLookupService<FilterInfo> presetLookupService;

    public FilterInfoMaintainServiceImpl(
            BatchCrudService<LongIdKey, FilterInfo> crudService,
            EntireLookupService<FilterInfo> entireLookupService,
            PresetLookupService<FilterInfo> presetLookupService
    ) {
