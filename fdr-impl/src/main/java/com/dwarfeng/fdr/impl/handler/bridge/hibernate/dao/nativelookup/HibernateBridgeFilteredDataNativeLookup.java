...
@Component
public class HibernateBridgeFilteredDataNativeLookup extends AbstractDialectNativeLookup<HibernateBridgeFilteredData> {

    public static final String SUPPORT_TYPE = "org.hibernate.dialect.MySQL8Dialect";

    public HibernateBridgeFilteredDataNativeLookup() {
        super(SUPPORT_TYPE);
    }
