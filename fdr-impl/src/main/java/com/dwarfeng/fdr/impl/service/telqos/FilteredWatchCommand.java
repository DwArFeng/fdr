...
@Component
public class FilteredWatchCommand extends WatchCommand<FilteredData> {

    public FilteredWatchCommand(FilteredWatchQosService filteredWatchQosService) {
        super("fw", "被过滤查看指令", filteredWatchQosService);
    }
