...
public final class Mysql8NativeLookupUtil {
    ...
    public static void pointLongIdEquals(
            StringBuilder sqlBuilder, String tableNameAlias, String pointLongIdColumnName
    ) {
        sqlBuilder.append(" ");
        sqlBuilder.append(tableNameAlias);
        sqlBuilder.append(".");
        sqlBuilder.append(pointLongIdColumnName);
        sqlBuilder.append(" = ?");
    }
