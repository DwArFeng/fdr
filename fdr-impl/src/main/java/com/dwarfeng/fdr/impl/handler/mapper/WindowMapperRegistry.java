...
public class WindowMapperRegistry extends AbstractMapperRegistry {
        ...
        private List<Sequence> windowSequence(
            ...
            while (timestamp <= lastTimestamp) {
                ...
                if (extendItem && itemIndex - 1 >= 0) {
                    subItems.add(items.get(itemIndex - 1));
                }
                ...
                if (extendItem && itemIndex < items.size()) {
                    subItems.add(items.get(itemIndex));
                }
    ...
    public static class Config implements Bean {
        ...
        private static final long serialVersionUID = 7019541140060754546L;
