...
/**
 * Hibernate 桥接器被触发数据本地查询。
 *
 * @author DwArFeng
 * @since 2.2.0
 */
public abstract class HibernateBridgeTriggeredDataNativeLookup extends
        AbstractDialectNativeLookup<HibernateBridgeTriggeredData> {

    public HibernateBridgeTriggeredDataNativeLookup(String supportDialect) {
     ...
     */
    protected abstract List<HibernateBridgeTriggeredData> lookupChildForPointBetweenCloseClose(
     ...
     * @throws SQLException SQL 异常。
     */
    protected abstract List<HibernateBridgeTriggeredData> lookupChildForPointBetweenCloseOpen(
            Connection connection, long pointLongId, Date startDate, Date endDate, int offset, int limit
    ) throws SQLException;
     ...
     * @throws SQLException SQL 异常。
     */
    protected abstract List<HibernateBridgeTriggeredData> lookupChildForPointBetweenOpenClose(
            Connection connection, long pointLongId, Date startDate, Date endDate, int offset, int limit
    ) throws SQLException;
     ...
     * @throws SQLException SQL 异常。
     */
    protected abstract List<HibernateBridgeTriggeredData> lookupChildForPointBetweenOpenOpen(
            Connection connection, long pointLongId, Date startDate, Date endDate, int offset, int limit
    ) throws SQLException;
    ...
    public String toString() {
        return "HibernateBridgeTriggeredDataNativeLookup{" +
