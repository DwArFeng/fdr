...
import com.dwarfeng.fdr.impl.handler.bridge.redis.serialize.RedisBridgeRedisSerializer;
...
public class RedisBridgeBaseConfiguration {
    ...
    public ParserConfig parserConfig() {
        ...
        parserConfig.addAccept(RedisBridgeFastJsonNormalData.class.getCanonicalName());
        parserConfig.addAccept(RedisBridgeFastJsonFilteredData.class.getCanonicalName());
        parserConfig.addAccept(RedisBridgeFastJsonTriggeredData.class.getCanonicalName());
        return parserConfig;
    }
