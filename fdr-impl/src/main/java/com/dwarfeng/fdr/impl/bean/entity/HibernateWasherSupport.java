...
@Table(name = "tbl_washer_support")
public class HibernateWasherSupport implements Bean {

    private static final long serialVersionUID = 8431442528736308038L;
