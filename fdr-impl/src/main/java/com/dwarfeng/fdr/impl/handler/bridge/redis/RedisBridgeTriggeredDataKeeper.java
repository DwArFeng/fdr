 ...
 */
@Component
public class RedisBridgeTriggeredDataKeeper extends AbstractKeeper<TriggeredData> {
    ...
    @Override
    protected TriggeredData doInspect(LongIdKey pointKey) throws Exception {
        RedisBridgeTriggeredData triggeredData = service.getIfExists(pointKey);
        return reverseTransform(triggeredData);
    }

    @Override
    protected List<TriggeredData> doInspect(List<LongIdKey> pointKeys) throws Exception {
