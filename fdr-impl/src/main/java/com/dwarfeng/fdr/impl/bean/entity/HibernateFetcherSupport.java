...
@Table(name = "tbl_fetcher_support")
public class HibernateFetcherSupport implements Bean {

    private static final long serialVersionUID = 3379286891593418102L;
    ...
    public HibernateFetcherSupport() {
    }
