...
public class PersistenceValueDaoImpl implements PersistenceValueDao {
    ...
    @Autowired
    private PresetLookupDao<PersistenceValue> presetLookupDao;
    @Autowired
    ...
    public PersistenceValue previous(LongIdKey pointKey, Date date) throws DaoException {
        return presetLookupDao.lookupFirst(
                PersistenceValueMaintainService.CHILD_FOR_POINT_PREVIOUS, new Object[]{pointKey, date}
        );
    }
    ...
    public PersistenceValue rear(LongIdKey pointKey, Date date) throws DaoException {
        return presetLookupDao.lookupFirst(
                PersistenceValueMaintainService.CHILD_FOR_POINT_REAR, new Object[]{pointKey, date}
        );
    }
}
