...
public class MockBridgeConfig {
    ...
    @Value("${com.dwarfeng.fdr.bridge.mock.update.delay}")
    private long updateDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.update.before_delay}")
    private long updateBeforeDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.update.after_delay}")
    private long updateAfterDelay;

    @Value("${com.dwarfeng.fdr.bridge.mock.latest.delay}")
    private long latestDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.latest.before_delay}")
    private long latestBeforeDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.latest.after_delay}")
    private long latestAfterDelay;

    @Value("${com.dwarfeng.fdr.bridge.mock.record.delay}")
    private long recordDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.record.before_delay}")
    private long recordBeforeDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.record.after_delay}")
    private long recordAfterDelay;

    @Value("${com.dwarfeng.fdr.bridge.mock.lookup.data_interval}")
    private long lookupDataInterval;
    @Value("${com.dwarfeng.fdr.bridge.mock.lookup.data_interval_nano_offset}")
    private int lookupDataIntervalNanoOffset;
    @Value("${com.dwarfeng.fdr.bridge.mock.lookup.delay}")
    private long lookupDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.lookup.offset_delay}")
    private long lookupOffsetDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.lookup.before_delay}")
    private long lookupBeforeDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.lookup.after_delay}")
    private long lookupAfterDelay;

    @Value("${com.dwarfeng.fdr.bridge.mock.native_query.delay_per_second}")
    private long nativeQueryDelayPerSecond;
    @Value("${com.dwarfeng.fdr.bridge.mock.native_query.before_delay}")
    private long nativeQueryBeforeDelay;
    @Value("${com.dwarfeng.fdr.bridge.mock.native_query.after_delay}")
