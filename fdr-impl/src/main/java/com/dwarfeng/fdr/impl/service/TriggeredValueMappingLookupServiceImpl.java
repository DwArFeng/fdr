...
@Service
public class TriggeredValueMappingLookupServiceImpl implements TriggeredValueMappingLookupService {

    private final TriggeredValueMappingLookupHandler handler;

    private final ServiceExceptionMapper sem;

    public TriggeredValueMappingLookupServiceImpl(
            TriggeredValueMappingLookupHandler handler, ServiceExceptionMapper sem
    ) {
