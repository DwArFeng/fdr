...
public class FilterInfoDaoImpl implements FilterInfoDao {
    ...
    private final BatchBaseDao<LongIdKey, FilterInfo> batchBaseDao;
    private final EntireLookupDao<FilterInfo> entireLookupDao;
    private final PresetLookupDao<FilterInfo> presetLookupDao;

    public FilterInfoDaoImpl(
            BatchBaseDao<LongIdKey, FilterInfo> batchBaseDao,
            EntireLookupDao<FilterInfo> entireLookupDao,
            PresetLookupDao<FilterInfo> presetLookupDao
    ) {
