...
public class LowPassMapperRegistry extends AbstractMapperRegistry {
    ...
    public LowPassMapperRegistry(ApplicationContext ctx) {
        super(MAPPER_TYPE);
        this.ctx = ctx;
    }
    ...
    public Mapper makeMapper() throws MapperException {
        try {
            return ctx.getBean(LowPassMapper.class);
        } catch (Exception e) {
    ...
    public static class LowPassMapper extends OneToOneMapper {
    ...
    public static class Config implements Bean {
        ...
        private static final long serialVersionUID = 7603831624365845688L;
