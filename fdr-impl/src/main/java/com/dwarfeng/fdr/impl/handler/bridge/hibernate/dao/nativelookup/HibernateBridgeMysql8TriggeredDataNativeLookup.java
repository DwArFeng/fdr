...
@Component
public class HibernateBridgeMysql8TriggeredDataNativeLookup extends HibernateBridgeTriggeredDataNativeLookup {

    public static final String SUPPORT_TYPE = "org.hibernate.dialect.MySQL8Dialect";

    public HibernateBridgeMysql8TriggeredDataNativeLookup() {
        super(SUPPORT_TYPE);
    }
    ...
    public String toString() {
        return "HibernateBridgeMysql8TriggeredDataNativeLookup{}";
    }
}
