 ...
 */
@Component
public class MockBridgeFilteredDataBridgePersister extends MockBridgePersister<FilteredData> {

    private static final Logger LOGGER = LoggerFactory.getLogger(MockBridgeFilteredDataBridgePersister.class);

    private final MockBridgeRandomGenerator randomGenerator;

    public MockBridgeFilteredDataBridgePersister(
    ...
    public String toString() {
        return "MockBridgeFilteredDataBridgePersister{" +
