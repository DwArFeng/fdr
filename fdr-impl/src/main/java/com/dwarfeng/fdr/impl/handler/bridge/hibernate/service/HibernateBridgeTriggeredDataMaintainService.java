...
/**
 * Hibernate 桥接器被触发数据维护服务。
 *
 * @author DwArFeng
 * @since 2.0.0
 */
public interface HibernateBridgeTriggeredDataMaintainService extends
        BatchCrudService<LongIdKey, HibernateBridgeTriggeredData>, EntireLookupService<HibernateBridgeTriggeredData>,
        PresetLookupService<HibernateBridgeTriggeredData>, BatchWriteService<HibernateBridgeTriggeredData> {
