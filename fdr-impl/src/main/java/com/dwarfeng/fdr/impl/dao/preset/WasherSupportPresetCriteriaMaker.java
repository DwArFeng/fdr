...
@Component
public class WasherSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case WasherSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case WasherSupportMaintainService.LABEL_LIKE:
