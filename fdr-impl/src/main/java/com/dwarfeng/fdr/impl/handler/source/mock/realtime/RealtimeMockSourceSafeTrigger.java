 ...
 * @since 3.0.1
 */
public final class RealtimeMockSourceSafeTrigger implements Trigger {

    private static final Logger LOGGER = LoggerFactory.getLogger(RealtimeMockSourceSafeTrigger.class);

    private final Trigger delegateTrigger;
    private final long misfireThreshold;
    private final long misfirePostpone;

    public RealtimeMockSourceSafeTrigger(Trigger delegateTrigger, long misfireThreshold, long misfirePostpone) {
    ...
    public Date nextExecutionTime(@Nonnull TriggerContext triggerContext) {
        ...
        LOGGER.warn(
                "实时模拟任务延迟超过阈值，原计划触发时间戳为 {}，当前时间戳为 {}，延迟时长为 {}，超过阈值 {}，" +
