...
public class PointDaoImpl implements PointDao {
    ...
    private final BatchBaseDao<LongIdKey, Point> batchBaseDao;
    private final EntireLookupDao<Point> entireLookupDao;
    private final PresetLookupDao<Point> presetLookupDao;

    public PointDaoImpl(
            BatchBaseDao<LongIdKey, Point> batchBaseDao,
            EntireLookupDao<Point> entireLookupDao,
            PresetLookupDao<Point> presetLookupDao
    ) {
