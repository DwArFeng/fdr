...
@Component
public class FetcherSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case FetcherSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case FetcherSupportMaintainService.LABEL_LIKE:
