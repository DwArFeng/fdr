...
## Release_3.0.0_20260417_build_A
...
## Release_2.5.0_20260416_build_A

### 功能构建

- Wiki 编写。
  - docs/wiki/zh-CN/RecordMemory.md。
...
## Release_2.4.0_20260407_build_A
...
## Release_2.3.2_20260126_build_A
...
- `fdr-node` 子模块类优化注释、文档注释格式、代码换行格式。
  - com.dwarfeng.fdr.node.configuration.FastJsonConfiguration。
...
## Release_2.3.1_20251011_build_A
...
## Release_2.3.0_20251006_build_A
