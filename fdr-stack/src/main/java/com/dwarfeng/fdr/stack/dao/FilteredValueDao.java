...
public interface FilteredValueDao extends BatchBaseDao<LongIdKey, FilteredValue>, EntireLookupDao<FilteredValue>,
     ...
     *
     * <p>
     * 该方法已过时。请使用 {@link FilteredValueMaintainService#CHILD_FOR_POINT_PREVIOUS} 预设查询代替。<br>
     ...
     *
     * <p>
     * 该方法已过时。请使用 {@link FilteredValueMaintainService#CHILD_FOR_POINT_REAR} 预设查询代替。<br>
     * 使用 {@link #lookupFirst(String, Object[])} 获得第一个元素。
     *
     * @param pointKey 指定的数据点。
     * @param date     指定的日期
